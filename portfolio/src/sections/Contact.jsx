            ...
            <div className=' social-items'>
              ...
              <div className='flex flex-wrap gap-2'>
                {socials.map((social, index) => (
                  <a key={index} className='text-xs leading-loose tracking-widest uppercase md:text-sm hover:text-white/60 transition-colors duration-200' target="_blank" rel="noopener noreferrer" href={social.href}>{`{ ${social.name} }`}</a>
                ))}
              </div>
            </div>
          </div>
