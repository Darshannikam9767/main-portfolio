            ...
            <div ref={contextRef}>
                <div style={{
                    ...
                    <div ref={headerRef} className='flex flex-col justify-center gap-12 pt-16 sm:gap-16'>
                        ...
                        <div className='px-10 '>
                            <h1 className='flex flex-col flex-wrap gap-12 text-black uppercase banner-text-responsive sm:gap-16 md:block '>Darshan Nikam</h1>
                        </div>
                    </div>
                </div>
                <div className='relative px-10 text-black'>
                    ...
                    <div className='py-12 sm:py-16 text-end overflow-hidden'>
                        <AnimatedTextLine className={'font-light uppercase value-text-responsive'} text={aboutText} />
                    </div>
                </div>
            </div>
